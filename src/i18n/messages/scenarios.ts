...
export const scenariosEn = {
  ...
  composition: {
    ...
    steps: {
      title: 'Steps',
      sequenceCaveat: 'Steps belong to this position in the flow. If you reorder, re-check them — especially “Reach”, whose path assumes the previous state. The agent treats them as advisory.',
      add: 'Step',
      remove: 'Remove step',
      empty: 'None',
...
export const scenariosKo: Localized<typeof scenariosEn> = {
  ...
  composition: {
    ...
    steps: {
      title: 'Step',
      sequenceCaveat: 'Step은 이 자리(순서) 기준이에요. 순서를 바꾸면 다시 확인하세요 — 특히 “도달”은 이전 상태를 가정합니다. 실행 시 에이전트에겐 advisory(참고)입니다.',
      add: 'Step',
      remove: 'Step 삭제',
      empty: '없음',
      intentLabel: '무엇을 할지',
