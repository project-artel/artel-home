...
export const scenariosEn = {
  ...
  chat: {
    ...
    proposalNew: '🆕 Add',
    proposalEdit: (_id: number) => '✏️ Edit',
  ...
  stepsEditor: {
    ...
    gapBlocks: 'Blocked by',
    gapHelp: 'Tell the chatbot how this is done and it will be filled in. A run skips this block: it is neither performed nor judged.',
  ...
  specViewer: {
    ...
    search: 'Search — step, scene, expected…',
    loading: 'Loading…',
  ...
  palette: {
    searchPlaceholder: 'Search cases — step, scene, id…',
    statusLabel: 'Status',
    sceneLabel: 'Scene',
    statusAll: 'All',
    sceneAll: 'All',
    sceneSearch: 'Search scene…',
...
export const scenariosKo: Localized<typeof scenariosEn> = {
  ...
  stepsEditor: {
    ...
    gapTitle: '경로 미상 — 이 자리에 스텝이 필요합니다',
    gapBlocks: '막는 것',
    gapHelp: '어떻게 하는지 챗봇에 알려주시면 채웁니다. 실행은 이 블록을 건너뜁니다 — 수행하지도 판정하지도 않습니다.',
    titleLabel: '시나리오 제목',
    actionLabel: '스텝 행위',
    actionPlaceholder: '플레이어가 하는 행동 또는 확인…',
    hintLabel: '힌트',
    hintPlaceholder: '힌트(선택)',
    addStep: '스텝 추가',
    remove: '스텝 삭제',
    moveUp: '위로',
    moveDown: '아래로',
  ...
  palette: {
    searchPlaceholder: '케이스 검색 — 스텝·씬·id…',
    statusLabel: '상태',
    sceneLabel: '씬',
    statusAll: '전체',
    sceneAll: '전체',
