 ...
 * ## 그림이 답하지 못하는 것을 답한다
 *
 * 그림은 "이 빌드가 어떻게 흘렀나"에 답한다. 상자 하나가 176 × 134 픽셀이고 그중 100 이 캡처라,
 * 그 화면이 어떻게 생겼는지까지는 그림이 답한다. 나머지는 답할 자리가 없다. 이 패널이 그 자리다:
 * 원래 크기의 캡처, 이 화면임을 판정하는 조건, 여기서 되는 조작, 여기에 묶인 지식.
 *
 * ## 색 없이도 전부 갈린다
 *
